...
function translateToFinnish() {
    ...
    for (var index = 0; !wordFound && index < englishWords.length; index++) {
...
var englishWords = ["cat", "dog", "bird", "dinosaur", "vasya", "computer", "memory"];
var finnishWords = ["kissa", "koira", "lintu", "dinosaurus", "davydov", "tietokone", "muisti"];
