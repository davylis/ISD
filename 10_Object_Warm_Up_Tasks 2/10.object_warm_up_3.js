    ...
    for (var index = 0; wordFound === false && index < wordArray.length; index++) {
        ...
        if (wordArray[index].englishWord === givenWord) {
            ...
            if (language === "finnish") {
                ...
                outputText = wordArray[index].russianWord;
            }
        }
    } 
...
var wordArray = [ 
    { englishWord: "cat", finnishWord: "kissa", swedishWord: "katt", russianWord: "kot"},
    { englishWord: "dog", finnishWord: "koira", swedishWord: "hund", russianWord: "sobaka" },
    { englishWord: "bird", finnishWord: "lintu", swedishWord: "fågel", russianWord: "pticha"},
    { englishWord: "crocodile", finnishWord: "krokotiili", swedishWord: "krokodil", russianWord: "krokodil" },
    { englishWord: "giraffe", finnishWord: "kirahvi", swedishWord: "giraff", russianWord: "zhiraf" },
    { englishWord: "bunny", finnishWord: "kani", swedishWord: "kanin", russianWord: "krolik"}
];
